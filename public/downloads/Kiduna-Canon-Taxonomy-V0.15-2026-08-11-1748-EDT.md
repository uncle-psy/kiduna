...
Patterns — reusable Scene templates that organize activity for particular purposes.
...
Forces are dynamic conditions acting on Sources, Avatars, Allies, Realms, Elements, relationships, resources, and activity. They shape what draws together or moves apart; what becomes visible or important; where attention, authority, energy, resources, and value flow; and how structures form, persist, compete, cooperate, weaken, renew, and change.
...
Gravity brings relevant things closer.
...
Affinity reveals meaningful proximity.
...
Authority reveals where legitimate power resides.
...
Influence reveals how ideas and behavior propagate.
...
Attention brings something forward.
Attention is finite.
...
Exchange becomes visible as flows.
...
Tension makes competing conditions perceptible.
...
Momentum reveals accelerating activity.
...
Entropy appears as weakening or fading structure.
...
It is a natural Force that makes maintenance, renewal, stewardship, pruning, archiving, succession, and Renewal necessary.
...
Renewal restores depleted relationships, Resources, Capacities, ecosystems, communities, institutions, knowledge, structures, and activity and increases their ability to flourish.
Renewal restores visible vitality.
Where Entropy describes natural dispersion and decay, Renewal describes the processes through which living systems renew themselves.
Renewal may occur through:
care;
maintenance;
repair;
reconciliation;
...
Renewal asks: What is being restored, renewed, or made capable of flourishing again?
...
Forces make relationships, conditions, movement, and relevance intelligible; help Sources navigate complexity; and reveal meaningful possibilities within the world.
Forces are not designed to maximize engagement, manufacture urgency, manipulate behavior, create addictive loops, or sell access to Attention.
...
A Force cannot override privacy, consent, governance, Roles, system-level boundaries, or legitimate Authority.
Forces shape how the world becomes perceptible and how conditions within it evolve.
The Source retains agency within it.
...
9. Patterns
Patterns are reusable Scene templates inside Kiduna.
Each Pattern defines the basic structure, behaviors, relationships, and tools needed for a particular kind of activity, providing a proven starting point for Scenes that can be adapted rather than built from scratch.
Viewport — navigate
