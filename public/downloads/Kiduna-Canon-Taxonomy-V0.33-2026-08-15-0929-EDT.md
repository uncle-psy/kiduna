...
Forces are dynamic conditions acting on Sources, Avatars, Allies, Realms, Elements, Resources, relationships, and activity. They shape what draws together or moves apart; what becomes visible or important; where attention, authority, energy, Resources, and value flow; and how structures form, persist, compete, cooperate, weaken, renew, and change.
...
Roles include Realm relationship Roles—Visitor, Guest, Member, Host, and Mage—and contribution Roles—Catalyst, Organizer, Creator, Builder, Luminary, and Sponsor.
...
A Source holding the Sponsor Role may pay for compute, provide Resources such as Rewards or Coupons, fund activity, or offer other agreed value.
...
Embodiment — a Pattern manifested as a whole Scene
An Embodiment is a Scene in which one Pattern is manifested wholesale as the Scene’s organizing template—not merely used as one part of the Scene and not mixed with other Patterns.
A Scene that uses only part of a Pattern or combines multiple Patterns is not an Embodiment of that Pattern.
Viewport — navigate
...
Sources can design, assemble, configure, test, and evolve Realms, Allies, Actors, Avatars and their representations, complete Scenes, and their Patterns, Elements, Resources, Capacities, Forms, Components, Dimensions, and Designs.
...
A Scene brings together Elements, Resources, Capacities, Patterns, Forms, Components, Dimensions, Designs, and the effects of Forces within a particular context.
