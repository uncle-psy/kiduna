...
Patterns — reusable Scene templates that organize Activities for particular Purposes.
Modes — the three concurrent ways of working with and experiencing the same underlying Realm or Scene: Forge, where changes are made; Rehearse, where Drafts are tested; and Field, where Sources participate in Published experiences through their Avatars.
...
Embodiment — an instantiated Pattern
When a Pattern is instantiated as a usable Scene, that instantiation is an Embodiment of the Pattern.
A Pattern may have many Embodiments. Each Embodiment follows the Pattern while remaining a distinct Scene with its own context, identity, contents, state, and access.
Archetype — the Ecosystem’s core Embodiment
An Archetype is the single core Embodiment of a core Pattern in the Kiduna Ecosystem.
It is the canonical Ecosystem-level instantiation of that Pattern that Sources can enter and use.
A core Pattern may have many other Embodiments throughout Kiduna, but only its one core Ecosystem Embodiment is its Archetype.
For example, the Viewport Pattern may have many Viewport Embodiments in different Realms, while the core Viewport in the Kiduna Ecosystem is the Viewport Archetype.
Viewport — navigate
...
World — act
Operate in a living environment where Sources, acting through their Avatars, and intelligent entities can perform work, coordinate Activities, and make things happen.
Forum — govern
...
Sources can design, assemble, configure, test, and evolve Realms, Gatherings, Activities, Allies, Actors, Avatars and their representations, complete Scenes, and their Purposes, Patterns, Elements, Resources, Capacities, Forms, Components, Dimensions, and Designs.
Rehearse — validate a Draft
Rehearse is the mode for reviewing, testing, and experiencing a Draft as it is intended to work before it becomes Published in Field.
A Source may Rehearse through their Avatar exactly as they would participate in the Published Scene.
...
Field is the mode for participating in and acting within the Published experience.
Sources participate through their Avatars where the Realm or Scene uses representation.
Sources, Allies, and Actors can organize, gather, create, build, govern, settle, enjoy, and act according to their Roles and Permissions.
Authorizing and publishing from Rehearse moves the relevant Realm, Ally, Actor, complete Scene, or other publishable work into the Published state in Field.
Publishing lifecycle
Forge → publish as Draft → Rehearse → authorize and publish → Published in Field.
Publishing changes availability; it does not create a different Scene.
Draft and Published are publication states of the same underlying work. A current Published version may remain available in Field while a new Draft is being created and Rehearsed.
Draft — awaiting validation
A Draft is a version published from Forge into Rehearse for validation.
A Draft is not yet the current experience available in Field and does not replace the current Published version.
Published — available in Field
Published is the authorized publication state of a version currently available in Field.
Publishing changes availability; it does not create a different Scene, Realm, Ally, Actor, or other underlying work.
...
It is no longer the current Field version but retains its identity, history, provenance, and required Records.
Retirement — authorized removal from Field
Retirement is the authorized process of removing Published work from Field.
...
Retired is the state of work that has been intentionally removed from Field through legitimate Authority.
Retired work is no longer available as an active Published experience, but its identity, history, provenance, and required Records remain.
...
A Scene brings together Purposes, Elements, Resources, Capacities, Patterns, Forms, Components, Dimensions, Designs, and the effects of Forces within a particular context.
...
A Scene can be presented concurrently in Forge, Rehearse, and Field according to each Source’s context, Role, Permissions, and the Scene’s Draft or Published publication state.
Scenes move from Forge through Rehearse to Field by being published first as Draft and then as Published.
