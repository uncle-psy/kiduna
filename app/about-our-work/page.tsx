  ...
  return (
    <main className={styles.page} id="main">
      ...
      <section className={styles.catalystSection} id="catalyst">
        <div className={styles.catalystHeading}><p className="eyebrow">About the catalyst · David Levine</p><h2>Thirty Years to Build<span>One Thing.</span></h2></div>
        <div className={styles.catalystBody}>
          <p className={styles.lead}>I’ve spent more than three decades building internet companies, platforms, and technologies while searching for something that seemed ever more elusive: a way to unite purpose and prosperity without sacrificing either.</p>
          <p>My work began near the birth of the commercial web. I founded one of the first web development companies, presented at the first International Conference on the World Wide Web at CERN in 1994, and wrote one of the earliest books about Java. Since then, I’ve built and patented technologies for financial markets, massively multiplayer online worlds, renewable energy, geospatial intelligence, decentralized infrastructure, and agentic AI.</p>
          <p>Along the way I found extraordinary mentors, developed powerful platforms, led movements, and worked across government, business, science, media, and civil society—from DARPA and NASA to IBM, Sony, GE, major financial institutions, global brands, nonprofits, and communities. Each chapter revealed another part of the same problem.</p>
          <p>Technology could amplify action, but it did not determine whom that power served. Economics could create abundance, but too often concentrated it. Governance could establish authority, but often moved it away from the people affected. Culture could create meaning and belonging, but could not act at institutional scale. Each offered part of the answer. None could solve the whole problem alone.</p>
          ...
          <p>My role is catalyst, not owner: to clarify the initial purpose, assemble the technology and legal foundations, gather the first participants, and help carry the organization into motion. The work becomes real only when other people enter it, govern it, challenge it, and make it their own.</p>
          <p className={styles.invitation}>To me, this is not another project or product launch. It is an invitation to become a real co-founder—and to co-create the next chapter of the internet itself.</p>
        </div>
