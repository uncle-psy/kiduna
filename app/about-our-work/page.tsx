    ...
    <main className={styles.page} id="main">
      ...
      <section className={styles.catalystSection} id="catalyst">
        ...
        <div className={styles.catalystBody}>
          <p className={styles.lead}>I’ve spent more than three decades building internet companies, platforms, and technologies while searching for something that grew ever more elusive: a way to unite purpose, prosperity, and people while protecting, preserving, and revitalizing the planetary ecosystem.</p>
