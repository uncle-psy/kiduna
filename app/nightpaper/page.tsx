      ...
      <div className={styles.readingLayout}>
        ...
        <article className={styles.article}>
          ...
          <section id="architecture" className={styles.section}>
            ...
            <p>At the genesis of Kiduna, Kinship Duna provides the legal and operational continuity of the ecosystem. It maintains the registered agent, banking and treasury relationships, shared infrastructure, legal response capacity, and the common Compute economy. Every member of a formal Kiduna Organization is also a member of Kinship Duna, so the ecosystem that supports the organizations is itself governed by its members.</p>
            <p>That structure is not intended to become a permanent central platform. The software will be open source. Other communities can operate independent ecosystems, adopt varying governing principles, issue different forms of Compute, and decide whether to connect with one another through the Kinship Agency Protocol. Kinship Duna is the genesis ecosystem: first, but not above the others.</p>
