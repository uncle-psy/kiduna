      ...
      <div className={styles.readingLayout}>
        ...
        <article className={styles.article}>
          ...
          <section id="care" className={styles.section}>
            ...
            <p>The measure is whether scale compounds agency: whether every increase in collective capacity makes people, relationships, projects, and organizations more capable of sensing, choosing, acting, and learning.</p>
          </section>
