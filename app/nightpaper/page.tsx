...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-nightpaper-v2.png", width: 1536, height: 1024, alt: "Kiduna — The Genesis Nightpaper: A New Architecture for Agentic Civilization" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "The Genesis Nightpaper — Kiduna",
    description: "A new architecture for agentic civilization.",
    images: ["/og-nightpaper-v2.png"],
  },
};
      ...
      <div className={styles.readingLayout}>
        ...
        <article className={styles.article}>
          ...
          <section id="ages" className={styles.section}>
            ...
            <p>All of that is about to change. Agency—the capacity to sense, understand, act, and learn—can now be extended through software. For the first time, the capacity for agency does not have to pool in the center the way institutional authority does.</p>
