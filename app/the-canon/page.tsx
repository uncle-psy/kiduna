      ...
      <section className={styles.hero}>
        <div className={styles.heroCopy}>
          ...
          <div className={styles.heroActions}>
            <a className={`button button-primary ${styles.heroDownload}`} href="/downloads/Kiduna-Kit-V0.07-2026-08-11-1748-EDT.zip" download>
      ...
      <section className={styles.kitSection} id="kiduna-kit">
        ...
        <div className={styles.kitCopy}>
          ...
          <div className={styles.kitDetails}>
            <span>Kit V0.07</span><span>Canon V0.15</span><span>11.0 MB</span><span>Verified release</span>
          </div>
          <div className={styles.kitActions}>
            <a className={`button button-primary ${styles.downloadButton}`} href="/downloads/Kiduna-Kit-V0.07-2026-08-11-1748-EDT.zip" download>
              <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 3v12" /><path d="m7 10 5 5 5-5" /><path d="M5 21h14" />
              </svg>
              Download the Kiduna Kit
            </a>
            <a className="text-link" href="/downloads/Kiduna-Canon-Taxonomy-V0.15-2026-08-11-1748-EDT.md" download>Download the Canon as Markdown</a>
          </div>
        </div>
      </section>
